...
tools: Read, Write, Bash, Glob, Grep, Skill, AskUserQuestion, SendMessage, Agent(vf-business-commercial, vf-business-delivery, vf-business-finance, quality-gate-client)
model: opus
effort: high
memory: project
---
