...
| 43-04-T3 | 43-04 | 2 | FABR-09 | T-43-30, T-43-31, T-43-34 | socle du bootstrap borné par la ligne `@bootstrap:socle` (hausse → DEPASSEMENT-BOOTSTRAP, rc 1 armé), plafond ADR-029 signalé par AU-DESSUS-PLAFOND-ADR029, non bloquant ; ligne citée, seule ajoutée, signalée à Samuel | unit (bash) + mutation + G-1 | BOOT-1..5, MUT-11 ; `REEL-BOOT rc=0 mesure=<n> ligne=<n>` ; `G1 rc=0/3` ; `BASELINE-DIFF ajoutees=1 bootstrap=1` | ❌ W0 | ⬜ pending |
