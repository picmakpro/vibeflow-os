...
- **Samuel Neveu — [@Samuel-Learnity](https://github.com/Samuel-Learnity)** — development workflow side: the `dev-orchestrator` module and the natural-language → pipeline experience.
