...
| `v2.23.0` | 2026-07-09 | Mission manager team: vf-dev-manager + specialized workers (minimal-context tree), mission detection in the router, size-based vf-auto dispatch (dev-orchestrator v1.5.0) |
