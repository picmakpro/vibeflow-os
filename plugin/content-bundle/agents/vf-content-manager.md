...
tools: Read, Write, Bash, Glob, Grep, Skill, AskUserQuestion, SendMessage, Agent(vf-content-strategist, vf-content-writer, vf-content-repurposer, content-clarity-judge)
model: opus
effort: high
memory: project
---
