...
extrait et généralisé depuis le track « équipe d'agents ».
...
### Dé-spécification vs source d'origine
...
- Suppression des références au suffixe `.dev` trompeur et des noms de flows spécifiques au projet d'origine ; le
