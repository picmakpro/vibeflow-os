...
| 42-01-T3 | 42-01 | 1 | FABR-01, FABR-05 | invocation nue sur cible ABSENTE hors --hook → INDÉTERMINÉ (D-20) ; T103, MUT-D20, jumeau vert (cible présente vide, régime F13 inchangé) | unit + mutation de code (QUAL-01) + E2E lab frais | `bash plugin/conductor/scripts/tests/test-check-agents.sh` ; sonde D20-OK / D20-JUMEAU-VERT-OK ; LAB-HOOK-SILENCIEUX-OK | ✅ | ⬜ pending |
...
| 42-05-T2 (checkpoint bloquant) | 42-05 | 3 | — | arbitrage de Samuel sur D-08 (réponse à D-19) transcrit sous forme fixe dans 42-D19-MESURE.md | manual + sonde machine | sonde `ARBITRAGE-*` (python3, regex sur les trois champs Décision/Canal/Date) | ✅ (artefact existe, section à ajouter) | ⬜ pending |
| 42-05-T3 | 42-05 | 3 | FABR-03, FABR-05 | I6 (T94, MUT-I6) TOUJOURS armé ; I5 (T93, MUT-I5, pose omitClaudeMd sur 4 juges + bump patch séparé) SEULEMENT si ARBITRAGE-MAINTENIR ; T96 (corpus réel + blueprints) | unit + mutation + integration, conditionnelle | suite + CI-REPLAY fail=0 (avec check-blueprints) ; branche I5-NON-ARME si non arbitré | ✅ | ⬜ pending |
...
| 42-06-T3 | 42-06 | 4 | FABR-05 | conductor en mineure (variante « I5 en attente » si non arbitré), docs, T76 intact, rejeu complet, G-2, relevé Samuel (dont ci.yml de 42-04) | integration (toutes suites + gates) | REJEU-FIN sans ligne rouge ; G2 rc=0 ; ✓ T76 | ✅ | ⬜ pending |
