...
warnings:
  - id: W1
    severity: warning
    what: "scripts/check-machine-paths.sh sort 1 sur l'arbre — c'est un gate CI (.github/workflows/ci.yml:359). Violation unique : .planning/phases/VFDO-28-.../28-RESEARCH.md:858 (« /Users/samuel »)."
