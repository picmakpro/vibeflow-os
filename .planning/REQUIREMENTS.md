...
- [ ] **ADPT-04**: Le gate de l'adaptateur est `codex doctor --json`, qui COMPTE les rôles chargés ET prouve un dispatch réel par nom — jamais « pas de crash donc c'est bon » (piège n°1 mesuré, dégradation silencieuse sur rôle malformé)
