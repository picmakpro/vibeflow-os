...
[![Version](https://img.shields.io/badge/version-2.43.1-2563eb)](./VERSION)
...
flowchart TD
    ...
    socle --> orch
    socle --> gouv
    CI["CI : 42 suites + job « lab frais »<br/>la baseline passe ses propres gates<br/>depuis un lab vierge"] -.-> socle
```
...
- **Auditable** : bash + `jq`, chaque script couvert par sa suite (`42 suites` en CI), install
