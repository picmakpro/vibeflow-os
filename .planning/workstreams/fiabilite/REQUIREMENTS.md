...
- [ ] **WSCH-05**: La doctrine (`workstreams.md`, ADR-069) énonce le choix au démarrage, sa valeur (deux flux disjoints qui avancent en parallèle) et le **non-choix par défaut** pour un lab solo.
