...
| BUDG-04 | Phase 40.1 | Pending — inscrite 2026-09-16 (arbitrages Samuel D-01/D-05/D-06) |
| BUDG-05 | Phase 40.1 | Pending — inscrite 2026-09-16 (arbitrages Samuel D-02/D-07) |
...
- [ ] **BUDG-04**: Le plafond ADR-029 des agents vaut 300 lignes partout où il est énoncé ou mesuré (gate, CI, suites de modules, auditeur de densité et méthodologie distribués, doctrine, manuel), avec un avertissement non bloquant dès 251 ; chaque outil garde sa mesure (fichier entier ou body) — Phase 40.1, D-01/D-05/D-06
- [ ] **BUDG-05**: Le ratchet du budget ne bloque plus que les ajouts d'instructions, par fichier ; une croissance de lignes sans instruction sous le plafond reste verte — prouvé par bascules sur fixture dans l'étape CI elle-même — Phase 40.1, D-02/D-07
