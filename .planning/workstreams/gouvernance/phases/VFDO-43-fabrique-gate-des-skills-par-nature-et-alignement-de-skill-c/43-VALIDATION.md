...
| 43-05-T2 | 43-05 | 2 | FABR-10 | T-43-40, T-43-41, T-43-42, T-43-44 | vf-mcp-tools malformée refusée à l'install et au gate | unit (bash) + mutation | test-inject-mcp-tools.sh T22a-g, `test-inject-mcp-tools:T34`, MUT-A ; test-vibeflow-update.sh T56 ; test-check-agents.sh T108 à T112 (parité gate ↔ injecteur pour toute valeur : guillemets T22e/T110, valeur sur la seule ligne de la clé T22f/T111, clé en double T22g/T112), MUT-M1 (refus du helper compté par une branche else) ; `CORPUS-AGENTS fail=0` ; `PREMIER-COMMIT-G2` | ✅ suites existantes | ⬜ pending |
