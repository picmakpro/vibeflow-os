...
- Exit 0 si tout passe, 1 sinon.
  ...
  <verify>
    <automated>/bin/bash -c 'cd "$(git rev-parse --show-toplevel)" && bash installer/scripts/tests/test-build-module-catalog.sh'</automated>
  </verify>
  <done>
